        ...
        <div className="hero-grid shell">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a className="button button-primary" href="https://github.com/MAO-TLs/oretsuba/releases/download/v1.1.5/OreTsuba-English-v1.1.5.zip">
            ...
            <p className="compatibility">
              12.5 MB · <a href="https://github.com/MAO-TLs/oretsuba/releases/tag/v1.1.5">Release notes</a>
              {" "}· Version 1.1.5 · Japanese retail v1.00 required
            </p>
          </div>
