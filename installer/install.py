...
def main():
 p=argparse.ArgumentParser(description='Install OreTsuba English v1.0.0. Close the game first.')
 ...
 with tempfile.TemporaryDirectory(prefix='mao-patch-',dir=game) as temp:
  ...
  try:
   ...
   raise
 print('English v1.0.0 installed. Originals are in MAO-original-backup. Restart the game and your Wine wrapper to load the font.')
